#!/usr/bin/env python3
"""Download official writeups for retired Hack The Box challenges."""
...
LIST_ENDPOINT = 'challenges'
WRITEUP_ENDPOINT = 'challenge/{id}/writeup/official'
SCRIPT_DIR = Path(__file__).resolve().parent
DEFAULT_OUTPUT_DIR = SCRIPT_DIR / "challenge"
KIND = 'challenge'
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description='Download official writeup PDFs for retired HTB challenges.',
    )
    parser.add_argument(
        "name",
        nargs="?",
    ...
    parser.add_argument(
        ...
        help="Destination directory (default: ./challenge next to this script).",
    )
    parser.add_argument(
        "--requests-per-minute",
        type=int,
